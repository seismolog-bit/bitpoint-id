        ...
        // <>
            <Layout title={props.name}>
                <div className="bg-white pb-12">
                    <div className="hero max-w-screen-lg mx-auto py-12">
                        <div className="mx-4 sm:mx-8 lg:mx-16 xl:mx-20 mx-auto">
                    ...
                    <img src={props.content.teaser_image} className="container mx-auto w-full object-cover lg:rounded" style={{ height : '28em'}}/>
                </div>
                
                <div className='max-w-screen-lg mx-auto'>
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <div className="px-4 lg:px-0 mb-12 text-gray-700 text-lg leading-relaxed w-full lg:w-3/4" dangerouslySetInnerHTML={{ __html: content }} />
                    </div>
                </div>
